...
constexpr uint16_t EU868_RX1_DELAY = 1000;  // ms
constexpr uint32_t EU868_RX2_FREQ = 869525000;
...
constexpr uint16_t US915_RX1_DELAY = 1000;
constexpr uint32_t US915_RX2_FREQ = 923300000;
